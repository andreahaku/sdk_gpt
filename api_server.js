...
app.post("/ask", async (req, res) => {
  try {
    ...
    const promptTemplate = "You are an expert in MetaMask documentation. If you know the answer give a detailed answer. If you don't know the answer say that you don't know. Provide code snippets every time when possible.";
